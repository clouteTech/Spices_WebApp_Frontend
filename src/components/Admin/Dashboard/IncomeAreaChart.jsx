  ...
  return (
    <>
      <LineChart
        ...
        xAxis={[
          { scaleType: "point", data: labels, tickSize: 7, disableLine: true },
        ]}
      ...
      >
        <defs>
          <linearGradient id="myGradient1" gradientTransform="rotate(90)">
            <stop
              offset="10%"
              stopColor={withAlpha(theme.palette.primary.main, 0.4)}
            />
            <stop
              offset="90%"
              stopColor={withAlpha(theme.palette.background.default, 0.4)}
            />
          </linearGradient>
          <linearGradient id="myGradient2" gradientTransform="rotate(90)">
            <stop
              offset="10%"
              stopColor={withAlpha(theme.palette.primary.dark, 0.4)}
            />
            <stop
              offset="90%"
              stopColor={withAlpha(theme.palette.background.default, 0.4)}
